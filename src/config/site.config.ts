...
export const DASHBOARDS = [
  ...
  {
    id: 'vendor-payable',
    title: 'Vendor Payable & Movement',
    description: 'Vendor-wise payable balances, aging analysis, monthly movement schedule, and upcoming payment tracker.',
    category: 'Vendors',
    tags: ['vendor', 'payable', 'aging', 'payment schedule', 'movement'],
    status: 'Preview' as const,
    featured: true,
    iconName: 'Truck',
    embedUrl: '',
